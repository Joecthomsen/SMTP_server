// Johannes C. Thomsen
//This program is a ESMTP application which enables you to send emails with attachment.

//The commented code enables the user to write his own email, however, the email is hardcoded in order to make efficient development.
